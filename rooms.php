  ...
  <body>
   ...
   <ol style="display:inline-block; list-style:none; padding:0; margin:0; ">
      ...
      <li style="display:inline;">
        <span style="color:gray;">Rooms</span>
      </li>
    </ol>
</div>
   <section class="ftco-section bg-light">
    	<div class="container">
	        ...
	        <div class="col-lg-12">
		    		<div class="row">
		    			<div class="col-sm col-md-8 col-lg-4 ftco-animate">
		    				<div class="room">
		    					...
		    					<!--<p><span class="price mr-2">$120.00</span> <span class="per">per night</span></p>-->	    						<ul class="list">
